 ...
 * 
 * @method _clickedImage пишет в HTML модального окна картинку и включает
 ...
 * картинки. Содержимое POST-запроса обрабатывается в index.php с помощью php-функции
 * updateSQLtable
 * 
